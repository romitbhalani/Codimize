    ...
    <svg style={baseStyle} viewBox="0 0 1400 800" preserveAspectRatio="xMidYMid slice">
      <defs>
        <radialGradient id="rga1" cx="75%" cy="15%" r="55%">
          <stop offset="0%"   stopColor="#0096FF" stopOpacity=".2"/>
        ...
        <radialGradient id="rga3" cx="50%" cy="50%" r="60%">
          <stop offset="0%"   stopColor="#0070CC" stopOpacity=".06"/>
      ...
      <polygon points="1100,20 1300,130 1300,350 1100,460 900,350 900,130"  fill="none" stroke="rgba(0,150,255,.10)" strokeWidth="1.5"/>
      <polygon points="1100,60 1270,158 1270,322 1100,420 930,322 930,158"  fill="none" stroke="rgba(0,150,255,.06)" strokeWidth="1"/>
      <polygon points="1100,100 1240,185 1240,295 1100,380 960,295 960,185" fill="none" stroke="rgba(0,150,255,.03)" strokeWidth="1"/>
      ...
      {/* Diamond shapes */}
      <rect x="520" y="60"   width="28" height="28" fill="none"                  stroke="rgba(56,190,255,.35)" strokeWidth="1.5" transform="rotate(45,534,74)"/>
      <rect x="240" y="300"  width="16" height="16" fill="rgba(0,150,255,.18)"                                                    transform="rotate(45,248,308)"/>
      <rect x="1250" y="640" width="20" height="20" fill="none"                  stroke="rgba(6,182,212,.22)"   strokeWidth="1.5" transform="rotate(45,1260,650)"/>
      <rect x="80"   y="120" width="12" height="12" fill="rgba(56,190,255,.15)"                                                    transform="rotate(45,86,126)"/>
      <rect x="700"  y="700" width="16" height="16" fill="none"                  stroke="rgba(0,150,255,.2)"   strokeWidth="1"   transform="rotate(45,708,708)"/>

      {/* Concentric circles — bottom center */}
      <circle cx="700" cy="900" r="320" fill="none" stroke="rgba(0,150,255,.05)" strokeWidth="1.5"/>
      <circle cx="700" cy="900" r="240" fill="none" stroke="rgba(0,150,255,.04)" strokeWidth="1"/>

      {/* Cross markers */}
      <line x1="420" y1="560" x2="420" y2="620" stroke="rgba(56,190,255,.22)" strokeWidth="1.5"/>
      <line x1="390" y1="590" x2="450" y2="590" stroke="rgba(56,190,255,.22)" strokeWidth="1.5"/>
    ...
    <svg style={baseStyle} viewBox="0 0 1400 600" preserveAspectRatio="xMidYMid slice">
      <defs>
        <radialGradient id="rgb1" cx="15%" cy="50%" r="50%">
          <stop offset="0%"   stopColor="#38BEFF" stopOpacity=".16"/>
          <stop offset="100%" stopColor="#38BEFF" stopOpacity="0"/>
        </radialGradient>
      ...
      <circle cx="80" cy="300" r="300" fill="none" stroke="rgba(56,190,255,.10)" strokeWidth="1.5"/>
      <circle cx="80" cy="300" r="220" fill="none" stroke="rgba(56,190,255,.06)" strokeWidth="1"/>
      <circle cx="80" cy="300" r="140" fill="none" stroke="rgba(56,190,255,.04)" strokeWidth="1"/>
      ...
      {/* Diamonds */}
      <rect x="400" y="70"  width="22" height="22" fill="none"                stroke="rgba(56,190,255,.3)" strokeWidth="1.5" transform="rotate(45,411,81)"/>
      <rect x="800" y="490" width="16" height="16" fill="rgba(6,182,212,.15)"                                                   transform="rotate(45,808,498)"/>

      {/* Cross */}
      <line x1="600" y1="100" x2="600" y2="155" stroke="rgba(56,190,255,.2)" strokeWidth="1.5"/>
      <line x1="572" y1="127" x2="628" y2="127" stroke="rgba(56,190,255,.2)" strokeWidth="1.5"/>
    ...
    <svg style={baseStyle} viewBox="0 0 1400 500" preserveAspectRatio="xMidYMid slice">
      <defs>
        <radialGradient id="rgc1" cx="50%" cy="50%" r="65%">
          <stop offset="0%"   stopColor="#0096FF" stopOpacity=".16"/>
          <stop offset="100%" stopColor="#0096FF" stopOpacity="0"/>
        </radialGradient>
      </defs>
      ...
      {[0,1,2,3,4,5,6,7,8].map(i => <line key={`d${i}`} x1={-300 + i*200} y1="500" x2={100  + i*200} y2="0"   stroke="rgba(0,150,255,.05)" strokeWidth="1"/>)}
      {[0,1,2,3,4,5,6,7,8].map(i => <line key={`u${i}`} x1={i*200}        y1="0"   x2={-200 + i*200} y2="500" stroke="rgba(0,150,255,.05)" strokeWidth="1"/>)}

      {/* Rotating rectangle — top left */}
      <rect x="80"  y="60"  width="200" height="200" rx="20" fill="none" stroke="rgba(0,150,255,.12)" strokeWidth="1.5" transform="rotate(15,180,160)"/>
      <rect x="110" y="90"  width="140" height="140" rx="16" fill="none" stroke="rgba(0,150,255,.07)" strokeWidth="1"   transform="rotate(15,180,160)"/>
      ...
      {/* Center circle */}
      <circle cx="700" cy="250" r="340" fill="none" stroke="rgba(56,190,255,.05)" strokeWidth="1"/>
    </svg>
  );
